...
const position1 = { top: '74%', left:  '3%',};
const position2 = { top: '45%', left:  '-3%'};
...
const position7 = { top: '74%', left:  '80%', };

const chipPosition0 = { top: '-16%', left:  '50%', transform: 'translateX(-50%)'};
const chipPosition1 = { top: '-85%', left:  '63%'};
...
const chipPosition7 = { top: '-85%', left:  '-74%'};

const cardPostion0 = {left: '0%', top: '0%'}
const cardPostion1 = {top: '-155%', left: '70%'   }
const cardPostion2 = {top: '-155%', left: '75%' }
const cardPostion3 = {top: '-155%', left: '70%'}
const cardPostion4 = {top: '-155%', left: '70%' }
const cardPostion5 = {top: '-155%', left: '70%' }
const cardPostion6 = {top: '-155%', left: '70%' }
const cardPostion7 = {top: '-155%', left: '70%' }
...
export const playerPositions = {
    ...
    5: [position0, position2, position3, position5, position6],
    6: [position0, position2, position3, position4, position5, position6],
    7: [position0, position2, position3, position4, position5, position6, position7],
...
export const chipPositions = {
    ...
    5: [chipPosition0, chipPosition2, chipPosition3, chipPosition5, chipPosition6],
    6: [chipPosition0, chipPosition2, chipPosition3, chipPosition4, chipPosition5, chipPosition6],
    7: [chipPosition0, chipPosition2, chipPosition3, chipPosition4, chipPosition5, chipPosition6, chipPosition7],
...
export const cardPositions = {
    ...
    5: [cardPostion0, cardPostion2, cardPostion3, cardPostion5, cardPostion6],
    6: [cardPostion0, cardPostion2, cardPostion3, cardPostion4, cardPostion5, cardPostion6],
    7: [cardPostion0, cardPostion2, cardPostion3, cardPostion4, cardPostion5, cardPostion6, cardPostion7],
