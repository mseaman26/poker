...
export const playerPositions = {
    ...
    3: [position1, position3, position5],
    4: [position1, position2, position4, position6],
    5: [position1, position1, position3, position5, position7],
    6: [position1, position1, position3, position4, position5, position7],
}