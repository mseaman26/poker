...
const position2 = { top: '50%', left:  '7%'};
const position3 = { top: '12%', left:  '8%'};
const position4 = { top: '10%', left:  '48%'};
const position5 = { top: '12%', left:  '92%'};
const position6 = { top: '50%', left:  '93%'};
...
const chipPosition2 = { top: '40%', left:  '110%'};
const chipPosition3 = { top: '160%', left:  '135%'};
const chipPosition4 = { top: '170%', left:  '85%'};
const chipPosition5 = { top: '160%', left:  '-60%'};
...
const cardPostion2 = {top: '-70%', left: '40%' }
const cardPostion3 = {top: '-35%', left: '70%'}
const cardPostion4 = {top: '30%', left: '-40%' }
const cardPostion5 = {top: '-35%', left: '-180%' }
const cardPostion6 = {top: '-70%', left: '-140%' }
